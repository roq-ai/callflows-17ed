...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'admin.count', 'diagram.count', 'owner.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('admin', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('diagram', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'diagram',
          header: 'Diagram',
          accessorKey: 'diagram',
          cell: ({ row: { original: record } }: any) => record?._count?.diagram,
        }
      : null,
